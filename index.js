import{a as m,i as p,S as we,b as N,N as j,P as H,A as ye}from"./assets/vendor-D3JqmkBw.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const P=document.getElementById("navbar-menu"),be=document.getElementById("open-menu"),ke=document.getElementById("close-menu"),Le=P.querySelector(".nav-list"),Se=P.querySelector(".mobile-menu-btn"),Z=document.querySelector(".header .consultation-btn"),B=document.getElementById("event-list");function R(){P.classList.add("is-hidden"),document.body.style.overflow=""}be.addEventListener("click",function(){P.classList.remove("is-hidden"),document.body.style.overflow="hidden"});ke.addEventListener("click",R);Le.addEventListener("click",R);Se.addEventListener("click",function(){R(),B&&B.scrollIntoView({behavior:"smooth"})});Z&&Z.addEventListener("click",function(){B&&B.scrollIntoView({behavior:"smooth"})});const se="https://events-store.b.goit.study/api",h={CATEGORIES:"/categories",EVENTS:"/events",LIMIT:8};m.defaults.baseURL=se;async function Ee(){return(await m.get(h.CATEGORIES)).data}async function F(e=1,t="",s=h.LIMIT){return t==="all"||!t?(await m.get(`${h.EVENTS}?page=${e}&limit=${s}`)).data:(await m.get(`${h.EVENTS}?page=${e}&limit=${s}&category=${t}`)).data}const a={categoriesListEl:document.querySelector(".js-event-category-list"),categoriesListOpenSvgBtn:document.querySelector(".icon-rotate"),caregoryListSelect:document.querySelector(".event-category-select"),categoriesListOpen:document.querySelector(".event-category-list"),eventsList:document.querySelector(".events-list"),firstCategoryButton:document.querySelector(".categories__btn"),showMoreBtn:document.querySelector(".show-more-btn"),loader:document.querySelector(".loader"),eventDetailsBtn:document.querySelector(".event-details-btn"),categoriesScroll:document.querySelector(".categories-scroll")};function xe(e,t){const s=e%4,n=e-s;return s===0||t<n?"row-of-4":s===3?"row-last-3":s===2?"row-last-2":s===1?"row-last-1":""}function V(){a.loader.classList.remove("is-hidden")}function W(){a.loader.classList.add("is-hidden")}function T(e="Щось пішло не так"){p.error({title:"Помилка",message:e,position:"topRight",timeout:5e3})}function Be(e){const t=[{_id:"all",name:"Всі події",tags:[]},...e],s=t.map(({_id:n,name:o,tags:i},r)=>{const d=xe(t.length,r),g=i.map(S=>`#${S} `).join("");return`<li class="event-category-item ${r===0?"is-active":""} ${d}" data-category="${n}">
          <p class="event-category-title">${o}</p>
          <p class="event-category-tags">${g}</p>
        </li>`}).join("");a.categoriesListEl.innerHTML=s,a.firstCategoryButton&&a.firstCategoryButton.classList.add("categories__btn--active")}a.caregoryListSelect.addEventListener("click",$e);function $e(e){a.categoriesListOpenSvgBtn.classList.toggle("icon-rotate-rotated"),a.categoriesListOpen.classList.toggle("is-hidden"),window.innerWidth<768&&!a.categoriesListOpen.classList.contains("is-hidden")&&setTimeout(()=>{if(!a.categoriesScroll.hasAttribute("data-simplebar")&&!a.categoriesScroll.SimpleBar){const t=new we(a.categoriesScroll,{autoHide:!1});a.categoriesScroll.SimpleBar=t}else a.categoriesScroll.SimpleBar&&a.categoriesScroll.SimpleBar.recalculate()},50)}function Q(e){const t="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwWTCjrYnFjj8EYfWdauJQ3dcybEFwaAIuRbQd8SQxu09hdbyzPESKpqs&s=10",s=e.map(({_id:n,name:o,price:i,category:r,image:d})=>`<li class="event-item">
        <img
          src="${d||t}"
          alt="${o}"
          width="335"
      ...
      </li>`).join("");a.eventsList.insertAdjacentHTML("beforeend",s)}const l="/goit-BC81-project-js-01/assets/sprite-kFDfZW0W.svg",_e="https://events-store.b.goit.study";async function Ie(e){try{const{data:t}=await m.get(`${_e}/api/events/${e}`);return t}catch(t){throw t}}function qe(e){const t=document.querySelector(".modal-product");if(!t)return;const{_id:s,name:n,description:o,image:i,durationHours:r,rate:d,price:g,audience:S,category:ue,program:me,inclusions:ge}=e;let f="";const D=Math.floor(d),E=d-D,X=E>=.25&&E<.75,ve=D+(X||E>=.75?1:0);for(let u=0;u<D;u+=1)f+=`
  ...
  `;t.innerHTML=pe}const Ce="https://events-store.b.goit.study/api",w=document.querySelector(".booking-modal"),ne=document.querySelector(".booking-modal-close-btn"),c=document.querySelector(".booking-modal-form"),$=document.querySelector(".booking-modal-submit-btn"),b=c.querySelector('[name="name"]'),k=c.querySelector('[name="phone"]'),L=c.querySelector('[name="comment"]'),_=b.closest(".booking-modal-field").querySelector(".booking-modal-error"),I=k.closest(".booking-modal-field").querySelector(".booking-modal-error"),q=L.closest(".booking-modal-field").querySelector(".booking-modal-error");c.addEventListener("submit",Oe);let G=null;function Me(e){G=e,document.body.style.overflow="hidden",w.classList.add("is-open"),document.addEventListener("keydown",oe),ne.addEventListener("click",ie),w.addEventListener("click",ae),Ne()}function O(){w.classList.remove("is-open"),c.reset(),K(),G=null,document.body.style.overflow="",document.body.classList.remove("no-scroll"),document.removeEventListener("keydown",oe),ne.removeEventListener("click",ie),w.removeEventListener("click",ae)}function oe(e){e.code==="Escape"&&O()}function ie(){O()}function ae(e){e.target===w&&O()}function Pe(){const e={},t=b.value.trim();t?(t.length<2||t.length>48)&&(e.name="Ім'я має бути від 2 до 48 символів"):e.name="Введіть ваше ім'я";const s=k.value.trim().replace(/\D/g,"");s?s.length!==12&&(e.phone="Телефон має містити рівно 12 цифр, напр. 380961234568"):e.phone="Введіть номер телефону";const n=L.value.trim();return n?n.length>256&&(e.comment=`Коментар занадто довгий (максимум 256 символів), а у вас ${n.length}`):e.comment="Введіть коментар",e}function Te(e){K(),e.name&&(b.classList.add("is-error"),_.textContent=e.name,_.classList.add("is-visible")),e.phone&&(k.classList.add("is-error"),I.textContent=e.phone,I.classList.add("is-visible")),e.comment&&(L.classList.add("is-error"),q.textContent=e.comment,q.classList.add("is-visible"))}function K(){b.classList.remove("is-error"),k.classList.remove("is-error"),L.classList.remove("is-error"),_.textContent="",I.textContent="",q.textContent="",_.classList.remove("is-visible"),I.classList.remove("is-visible"),q.classList.remove("is-visible")}async function Oe(e){e.preventDefault();const t=Pe();if(t.name||t.phone||t.comment){Te(t);return}K();const s={name:b.value.trim(),phone:k.value.trim().replace(/\D/g,""),eventId:G,comment:L.value.trim()};try{De(),Fe(),$.disabled=!0;const{data:n}=await m.post(`${Ce}/orders`,s),{eventName:o,orderNum:i}=n;p.success({message:`Дякуємо! Ви замовили івент до ${o}, ваше замовлення №${i}. Очікуйте на зворотній зв'язок.`,position:"topRight",timeout:6e3}),O(),He()}catch(n){n.status===400&&p.error({message:"Помилка запиту",position:"topRight",timeout:6e3}),n.status===404&&p.error({message:"Немає такого івенту =(",position:"topRight",timeout:6e3})}finally{Ae(),Ve(),$.disabled=!1}}function Ae(){$.classList.remove("is-hidden")}function De(){$.classList.add("is-hidden")}const U="dataBooking",x={name:"",phone:"",comment:""};function Ne(){je(),c.addEventListener("input",Re)}function je(){const e=JSON.parse(localStorage.getItem(U));e&&(c.elements.name.value=e.name,c.elements.phone.value=e.phone,c.elements.comment.value=e.comment)}function He(){localStorage.removeItem(U),c.name="",c.phone="",c.comment=""}function Re(e){e.target===c.elements.name&&(x.name=e.target.value),e.target===c.elements.phone&&(x.phone=e.target.value),e.target===c.elements.comment&&(x.comment=e.target.value),localStorage.setItem(U,JSON.stringify(x))}const re=document.querySelector(".loader-booking");function Fe(){re.classList.remove("is-hidden")}function Ve(){re.classList.add("is-hidden")}let v=1,C="all",y=0,A=0;function Y(){return window.innerWidth<768?h.LIMIT/2:h.LIMIT}async function We(){try{V();const e=Y(),[t,s]=await Promise.all([Ee(),F(v,C,e)]);Be(t),a.eventsList.innerHTML="",Q(s.events),y=s.events.length,A=s.totalItems,M()}catch(e){T("Не вдалося завантажити список подій"),console.log("error events list",e)}finally{W()}}async function Qe(e){const t=document.querySelector(".event-category-item.is-active");t&&t.classList.remove("is-active"),a.showMoreBtn.classList.add("is-hidden-btn-more");const s=e.target.closest(".event-category-item");if(!s)return;s.classList.add("is-active");const n=s.querySelector(".event-category-title").textContent;document.querySelector(".current-category").textContent=n;try{V(),C=s.dataset.category,v=1,y=0,a.eventsList.innerHTML="";const o=Y(),i=await F(v,C,o);Q(i.events),y=i.events.length,A=i.totalItems,M()}catch(o){T("Не вдалося завантажити список категорій подій"),console.log("error during getting events by category",o)}finally{W()}}async function Ge(){try{V(),a.showMoreBtn.disabled=!0,a.showMoreBtn.style.opacity="0",v+=1;const e=Y(),t=await F(v,C,e);if(!t.events.length){v-=1,M(),a.showMoreBtn.disabled=!0;return}Q(t.events),y+=t.events.length,A=t.totalItems,M()}catch(e){T("Не вдалося завантажити список більше подій"),console.log("error during getting more events by category",e),v-=1}finally{W(),a.showMoreBtn.style.opacity="1"}}function M(){a.showMoreBtn.classList.remove("is-hidden-btn-more"),y>=A?a.showMoreBtn.disabled=!0:a.showMoreBtn.disabled=!1}async function le(e){const t=e.target.closest(".event-details-btn");if(!t)return;const s=t.dataset.eventId;if(s)try{const n=await Ie(s);qe(n);const o=document.querySelector(".section.event-details-modal"),i=document.querySelector(".event-modal-overlay");o&&i&&(o.classList.remove("is-hidden"),i.classList.add("is-open"),document.body.classList.add("no-scroll")),i.addEventListener("click",J),window.addEventListener("keydown",z);const r=i.querySelector(".modal-event__order-btn");r&&r.addEventListener("click",Ke)}catch(n){T("Не вдалося завантажити інформацію про дану подію"),console.log("error during opening event modal",n)}}function J(e){const t=document.querySelector(".event-modal-overlay"),s=e.target.hasAttribute("data-modal-close")||e.target.classList.contains("modal-close-btn"),n=e.target===t;(s||n)&&ce()}function z(e){e.code==="Escape"&&ce()}function ce(){const e=document.querySelector(".section.event-details-modal"),t=document.querySelector(".event-modal-overlay");if(e&&t){e.classList.add("is-hidden"),t.classList.remove("is-open"),document.body.classList.remove("no-scroll"),t.removeEventListener("click",J),window.removeEventListener("keydown",z);const s=t.querySelector(".modal-product");s&&(s.innerHTML="")}}function Ke(e){const t=e.currentTarget.dataset.eventId,s=document.querySelector(".section.event-details-modal"),n=document.querySelector(".event-modal-overlay");if(s&&n){s.classList.add("is-hidden"),n.classList.remove("is-open"),n.removeEventListener("click",J),window.removeEventListener("keydown",z);const i=n.querySelector(".modal-product");i&&(i.innerHTML="")}Me(t);const o=document.querySelector(".section.booking-modal");if(o){o.classList.remove("is-hidden"),o.classList.add("is-open"),document.body.classList.add("no-scroll");const i=o.querySelector(".booking-modal_form");if(i){let r=i.querySelector('input[name="eventId"]');r||(r=document.createElement("input"),r.type="hidden",r.name="eventId",i.appendChild(r)),r.value=t}}}m.defaults.baseURL=se;const ee="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwWTCjrYnFjj8EYfWdauJQ3dcybEFwaAIuRbQd8SQxu09hdbyzPESKpqs&s=10";async function Ue(){return(await m.get(`${h.EVENTS}?type=popular`)).data}function Ye(e){const t=document.querySelector(".popular-list"),s=e.map(({_id:n,name:o,price:i,category:r,image:d})=>`<li class="swiper-slide event-item">
        <img
          src="${d||ee}"
          alt="${o}"
          width="335"
