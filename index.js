import{a as m,S as te,b as oe,N as ne,P as se,A as ie,i as A}from"./assets/vendor-J54O91YU.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();const q=document.getElementById("navbar-menu"),re=document.getElementById("open-menu"),ae=document.getElementById("close-menu"),ce=q.querySelector(".nav-list"),le=q.querySelector(".mobile-menu-btn"),W=document.querySelector(".header .consultation-btn"),E=document.getElementById("event-list");function I(){q.classList.add("is-hidden"),document.body.style.overflow=""}re.addEventListener("click",function(){q.classList.remove("is-hidden"),document.body.style.overflow="hidden"});ae.addEventListener("click",I);ce.addEventListener("click",I);le.addEventListener("click",function(){I(),E&&E.scrollIntoView({behavior:"smooth"})});W&&W.addEventListener("click",function(){E&&E.scrollIntoView({behavior:"smooth"})});window.addEventListener("keydown",function(e){e.key==="Escape"&&I()});const de="https://events-store.b.goit.study/api",u={CATEGORIES:"/categories",EVENTS:"/events",LIMIT:8};m.defaults.baseURL=de;async function ue(){return(await m.get(u.CATEGORIES)).data}async function D(e=1,t="",n=u.LIMIT){return t==="all"||!t?(await m.get(`${u.EVENTS}?page=${e}&limit=${n}`)).data:(await m.get(`${u.EVENTS}?page=${e}&limit=${n}&category=${t}`)).data}const a={categoriesListEl:document.querySelector(".js-event-category-list"),categoriesListOpenSvgBtn:document.querySelector(".icon-rotate"),caregoryListSelect:document.querySelector(".event-category-select"),categoriesListOpen:document.querySelector(".event-category-list"),eventsList:document.querySelector(".events-list"),firstCategoryButton:document.querySelector(".categories__btn"),showMoreBtn:document.querySelector(".show-more-btn"),loader:document.querySelector(".loader"),eventDetailsBtn:document.querySelector(".event-details-btn"),categoriesScroll:document.querySelector(".categories-scroll")};function me(e,t){const n=e%4,o=e-n;return n===0||t<o?"row-of-4":n===3?"row-last-3":n===2?"row-last-2":n===1?"row-last-1":""}function C(){a.loader.classList.remove("is-hidden")}function M(){a.loader.classList.add("is-hidden")}let ve=!1;function ge(e){const t=[{_id:"all",name:"Всі події",tags:[]},...e],n=t.map(({_id:o,name:s,tags:i},r)=>{const h=me(t.length,r),v=i.map(L=>`#${L} `).join("");return`<li class="event-category-item ${h}" data-category="${o}">
      ...
      </li>`).join("");a.eventsList.insertAdjacentHTML("beforeend",t)}const S="/goit-BC81-project-js-01/assets/sprite-kFDfZW0W.svg",pe="https://events-store.b.goit.study";async function ye(e){try{const{data:t}=await m.get(`${pe}/api/events/${e}`);return t}catch(t){throw t}}function he(e){const t=document.querySelector(".modal-product");if(!t)return;const{_id:n,name:o,description:s,image:i,durationHours:r,rate:h,price:v,audience:L,category:K,program:Y,inclusions:Z}=e;let g="";const P=Math.floor(h),b=h-P,V=b>=.25&&b<.75,J=P+(V||b>=.75?1:0);for(let c=0;c<P;c+=1)g+=`
    ...
    <div class="modal-event__wrapper">
      ...
      <div class="modal-event__content">
        <div class="modal-event__header-meta">
          ...
          <div class="modal-event__stars">${g}</div>
        </div>
