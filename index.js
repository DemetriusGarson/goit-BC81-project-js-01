import{a as m,i as p,S as ye,b as N,N as j,P as H,A as we}from"./assets/vendor-Ba6nf5l4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();const T=document.getElementById("navbar-menu"),be=document.getElementById("open-menu"),ke=document.getElementById("close-menu"),Le=T.querySelector(".nav-list"),Se=T.querySelector(".mobile-menu-btn"),Z=document.querySelector(".header .consultation-btn"),$=document.getElementById("event-list");function R(){T.classList.add("is-hidden"),document.body.style.overflow=""}be.addEventListener("click",function(){T.classList.remove("is-hidden"),document.body.style.overflow="hidden"});ke.addEventListener("click",R);Le.addEventListener("click",R);Se.addEventListener("click",function(){R(),$&&$.scrollIntoView({behavior:"smooth"})});Z&&Z.addEventListener("click",function(){$&&$.scrollIntoView({behavior:"smooth"})});const ne="https://events-store.b.goit.study/api",h={CATEGORIES:"/categories",EVENTS:"/events",LIMIT:8};m.defaults.baseURL=ne;async function Ee(){return(await m.get(h.CATEGORIES)).data}async function F(e=1,t="",n=h.LIMIT){return t==="all"||!t?(await m.get(`${h.EVENTS}?page=${e}&limit=${n}`)).data:(await m.get(`${h.EVENTS}?page=${e}&limit=${n}&category=${t}`)).data}const a={categoriesListEl:document.querySelector(".js-event-category-list"),categoriesListOpenSvgBtn:document.querySelector(".icon-rotate"),caregoryListSelect:document.querySelector(".event-category-select"),categoriesListOpen:document.querySelector(".event-category-list"),eventsList:document.querySelector(".events-list"),firstCategoryButton:document.querySelector(".categories__btn"),showMoreBtn:document.querySelector(".show-more-btn"),loader:document.querySelector(".loader"),eventDetailsBtn:document.querySelector(".event-details-btn"),categoriesScroll:document.querySelector(".categories-scroll")};function xe(e,t){const n=e%4,s=e-n;return n===0||t<s?"row-of-4":n===3?"row-last-3":n===2?"row-last-2":n===1?"row-last-1":""}function V(){a.loader.classList.remove("is-hidden")}function W(){a.loader.classList.add("is-hidden")}function P(e="Щось пішло не так"){p.error({title:"Помилка",message:e,position:"topRight",timeout:5e3})}function $e(e){const t=[{_id:"all",name:"Всі події",tags:[]},...e],n=t.map(({_id:s,name:o,tags:i},r)=>{const d=xe(t.length,r),g=i.map(S=>`#${S} `).join("");return`<li class="event-category-item ${r===0?"is-active":""} ${d}" data-category="${s}">
